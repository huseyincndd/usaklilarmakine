...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-green-950 via-emerald-950 to-green-900 text-white relative overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
          ...
          <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
            <defs>
              <pattern id={gridPatternId} width="60" height="60" patternUnits="userSpaceOnUse">
                <path d="M 60 0 L 0 0 0 60" fill="none" stroke="rgba(34, 197, 94, 0.3)" strokeWidth="1" />
              </pattern>
            </defs>
        ...
        {/* Animated Green Orbs */}
        <motion.div
          className="absolute top-1/4 left-1/6 w-96 h-96 bg-emerald-500/20 rounded-full blur-3xl"
          animate={{ 
            scale: [1, 1.4, 1],
            opacity: [0.3, 0.5, 0.3],
            x: [0, 50, 0],
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/6 w-[500px] h-[500px] bg-green-500/25 rounded-full blur-3xl"
          animate={{ 
            scale: [1, 1.5, 1],
        ...
        />
        <motion.div
          className="absolute top-1/2 right-1/3 w-80 h-80 bg-emerald-400/15 rounded-full blur-3xl"
          animate={{ 
            scale: [1, 1.3, 1],
        ...
        />
        <motion.div
          className="absolute bottom-1/3 left-1/2 w-72 h-72 bg-green-400/20 rounded-full blur-3xl"
          animate={{ 
            scale: [1, 1.35, 1],
            opacity: [0.25, 0.4, 0.25],
            x: [0, -30, 0],
        ...
        {/* Subtle Lines */}
        <motion.div
          className="absolute top-1/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-emerald-400/20 to-transparent"
          initial={{ scaleX: 0 }}
        ...
        />
        <motion.div
          className="absolute bottom-1/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-green-400/20 to-transparent"
          initial={{ scaleX: 0 }}
          whileInView={{ scaleX: 1 }}
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <motion.a 
                    ...
                    className="w-12 h-12 bg-green-500/20 backdrop-blur-sm border border-green-400/30 rounded-xl flex items-center justify-center hover:bg-green-500/30 hover:border-green-400/60 transition-all duration-300 group"
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div>
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 bg-white/10 border border-green-500/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:border-green-400/60 focus:bg-white/15 transition-all duration-300"
                    />
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      pattern="[0-9]*"
                      inputMode="numeric"
                      className="w-full pl-24 pr-4 py-3 bg-white/10 border border-green-500/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:border-green-400/60 focus:bg-white/15 transition-all duration-300"
                    />
                  </div>
                  ...
                  <div>
                    <textarea
                      ...
                      rows={4}
                      required
                      className="w-full px-4 py-3 bg-white/10 border border-green-500/30 rounded-xl text-white placeholder-white/60 focus:outline-none focus:border-green-400/60 focus:bg-white/15 transition-all duration-300 resize-none"
                    />
                  </div>
                  ...
                  <motion.button
                    ...
                    className="w-full px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed border-2 border-green-400/50 shadow-lg"
                    whileHover={{ scale: 1.03, boxShadow: "0 10px 40px rgba(34, 197, 94, 0.3)" }}
                    whileTap={{ scale: 0.98 }}
                  >
              ...
              >
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="w-10 h-10 bg-green-500/20 border border-green-400/30 rounded-xl flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-green-400">info@usaklilarmakine.com</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-white/80">12345 Aydın / Türkiye</p>
